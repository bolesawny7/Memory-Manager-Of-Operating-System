...
//	else {
//		cprintf("GET SIZE OF SHARED OBJECT: share size = %d\n", ptr_share->size);
...
//	struct FrameInfo** frames_storage;
//
//	acquire_spinlock(&(AllShares.shareslock));
//	frames_storage = (struct FrameInfo**)kmalloc(sizeOfFrames);
...
//	//Your Code is Here...
//	acquire_spinlock(&(AllShares.shareslock));
//	if(&(AllShares.shares_list).size == 0) {
//        release_spinlock(&(AllShares.shareslock));
//        return NULL;
//    }
//
...
//			// release
//			cprintf("GET SHARE: share found at %p\n", share_itr);
//			release_spinlock(&(AllShares.shareslock));
//			return share_itr;
//		}
//	}
